...
public class CbxMetadataExtractor implements FileMetadataExtractor {
    ...
    private InputStream findComicInfoEntryInputStream(Path cbxPath) throws LibArchiveException, IOException {
        ...
        return Archive.getInputStream(cbxPath, comicInfoEntry);
    }
